...
tags:
  ...
  - HTTP
  - 资源和URI
excerpt: URI/URL/URN 概念与语法结构笔记，涵盖 scheme、authority、path、query 及 Data URL 等组成部分。
---
...
URI 的最常见形式是统一资源定位符 ([URL](https://developer.mozilla.org/zh-CN/docs/Glossary/URL))，它也被称为 _Web 地址_。
...
文本文件默认值。即使它_意味着未知的文本文件_，但浏览器认为是可以直接展示的。
