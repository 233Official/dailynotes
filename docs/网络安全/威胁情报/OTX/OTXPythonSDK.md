...
tags:
  - OTX
  - Python
excerpt: OTX Python SDK 的安装配置与基本用法，用于从 AlienVault OTX 平台自动获取威胁情报指标。
---
...
OTX Direct Connect 提供了一种机制，可以将 Open Threat Exchange 门户中的入侵指标 (IoC) 自动提取到您的环境中。DirectConnect API 允许您访问您在 Open Threat Exchange ( [https://otx.alienvault.com](https://otx.alienvault.com/) ) 中订阅的所有 _Pulses_ 。
