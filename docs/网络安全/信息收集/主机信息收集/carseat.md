...
tags:
  ...
  - 安全审计
  - TODO
excerpt: Carseat —— Python 实现的安全审计工具，支持远程执行 Seatbelt 模块，涵盖系统信息收集、安全配置评估与凭证分析。
---
