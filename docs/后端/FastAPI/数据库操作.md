...
tags:
  ...
  - FastAPI
  - 数据库操作
excerpt: FastAPI 集成 SQLAlchemy 进行数据库操作，包括 engine 创建、Model 定义、CRUD 封装和 ORM mode。
---
...
> [【独家新技术】从0到1学习 FastAPI 框架的所有知识点\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1iN411X72b?p=35)
...
> [**mapper_args** = {"order_by":...-慕课网 (imooc.com)](https://www.imooc.com/qadetail/353354)
>
