...
tags:
  ...
  - FastAPI
  - 测试用例
excerpt: 使用 FastAPI TestClient 和 pytest 编写接口测试用例，包含后台任务等场景的测试方法。
---
...
>
> [【独家新技术】从0到1学习 FastAPI 框架的所有知识点\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1iN411X72b?p=43)
