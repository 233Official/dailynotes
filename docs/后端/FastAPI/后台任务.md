...
tags:
  ...
  - FastAPI
  - 后台任务
excerpt: FastAPI BackgroundTasks 后台任务的使用方法，包括独立使用和与依赖注入系统配合。
---
...
> [【独家新技术】从0到1学习 FastAPI 框架的所有知识点\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1iN411X72b?p=41)
>
