...
- [PDFMathTranslate-next-基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker](https://github.com/PDFMathTranslate-next/PDFMathTranslate-next)
  ...
  > 沉浸式翻译 BabelDOC针对PDF的翻译效果特别好，对公式和排版的影响特别小。但前段时间启用了免费用户限制，每月50w token完全不够用。 项目核心已经开源[BabelDOC](https://github.com/funstory-ai/BabelDOC)，而针对webui以及自部署的项目是[PDFMathTranslate-next](https://github.com/PDFMathTranslate-next/PDFMathTranslate-next)。 经过一段时间使用，发现有一些问题： 原有项目的webui是纯前端项目，并且配置保存时灵时不灵，有时刷新配置项就消失让人很…
  >
  > --- by Sxuking

- [superpowers-一套行之有效的智能技能框架和软件开发方法论](https://github.com/obra/superpowers?tab=readme-ov-file)
