...
tags:
  - Python
  - 环境配置
excerpt: Python 开发环境配置指南，涵盖安装、pip 换源、版本管理工具及 VSCode 调试设置。
sticky: 1
star: True
headerDepth: 5
---
...
- 修改默认 Python 版本
  ...
  > [【Python】Ubuntu修改默认Python版本\_remo0x的博客-CSDN博客\_ubuntu更改默认python版本](https://blog.csdn.net/White_Idiot/article/details/78240298)
  >
  > ***
...
> ⚠️ 注意：一定使用 make altinstall 而不是 make install，否则会破坏系统依赖的 python3.10。
...
> [python 项目自动生成环境配置文件requirements.txt\_凝眸伏笔的博客-CSDN博客](https://blog.csdn.net/pearl8899/article/details/113877334)
