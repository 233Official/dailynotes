...
tags:
  - Shell
excerpt: PowerShell 常用操作与脚本语法整理，涵盖网络配置、主题美化及文件操作。
---
...
> [PowerShell制作提示窗口\_powershell怎么创建弹窗消息-CSDN博客](https://blog.csdn.net/weixin_39802884/article/details/119250927)
