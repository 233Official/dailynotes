...
tags:
  - CS
  - 统括
excerpt: CS 自学规划与进度跟踪，以 TeachYourselfCS 等路线为基底，涵盖 SICP、C 语言、算法与工具链学习。
article: False
---
...
>
> [Vue3\_小满zs的博客-CSDN博客](https://blog.csdn.net/qq1195566313/category_11618172.html)

- [vue3 从入门到精通\_猪场前端程序媛@哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1W34y1i7cG?p=3)
  - ~~62 P, 855 min, 7 天学完, 划成每天 123 min, 由于分钟不好计算, 不如直接分 p 划分了, 每天 9 P~~ `寄`

- [【尚硅谷】Vue3 全套教程Web前端丨vuejs 轻松掌握\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1NR4y1x7Ab?spm_id_from=333.999.0.0)
...
- [Vue3\_小满zs的博客-CSDN博客](https://blog.csdn.net/qq1195566313/category_11618172.html)
  ...
  [Vue3 + vite + Ts + pinia + 实战 + 源码\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1dS4y1y7vd?p=14&spm_id_from=333.880.my_history.page.click)
