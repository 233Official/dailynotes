import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as e,o as p,c as t,a,d as l,b as i,e as r}from"./app-BClezd5_.js";const c={},o=a("h1",{id:"内网信息收集",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#内网信息收集"},[a("span",null,"内网信息收集")])],-1),u=a("h2",{id:"fscan",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#fscan"},[a("span",null,"fscan")])],-1),v={href:"https://github.com/shadow1ng/fscan",target:"_blank",rel:"noopener noreferrer"},d=r(`<p>简单用法</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>fscan.exe <span class="token parameter variable">-h</span> <span class="token number">192.168</span>.1.1/24  <span class="token punctuation">(</span>默认使用全部模块<span class="token punctuation">)</span>
